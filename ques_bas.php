...
<html >
  ...
  <section class="back_playing">
    <img class="top-img" src="images\parddy2.png" >
 ...
 <div class="col">
    ...
    <div class="right-box">
        <h2 class="level-title"> اللعز الاول</h2>

        <div class="symbols">
       <h3>  𓋴 𓇋 𓋴 𓅓  𓂋 </h3>
        </div>

        <input class="input-box" type="text" placeholder="حول الرموز الهيروغليفية الى عربي">
